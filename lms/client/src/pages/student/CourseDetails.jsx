...
//           <h1 className='md:text-4xl font-semibold text-gray-800'>{courseData.courseTitle}</h1>
...
//         {/*right col */}
//         <div className='max-w-[424px] z-10  rounded-t 
...
//               </div>
//             </div>
//             <button onClick={enrollCourse} className='md:mt-5 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium cursor-pointer'
...
//                 <li>Certificate of compeltion</li>
//               </ul>
//             </div>
//           </div>
//         </div>
...
const CourseDetails = () => {
  ...
  const isCourseCreator =
    userData && courseData && userData._id === courseData.educator._id
  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        {/* Left Column */}
        <div className='max-w-xl z-10 text-gray-500'>
          <h1 className='md:text-4xl font-semibold text-gray-800'>
          ...
          <div className='p-5'>
            ...
            {!isCourseCreator && (
              <button
                ...
                className='md:mt-5 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium cursor-pointer'
              >
            ...
            {isCourseCreator && (
              <button
                ...
                className='md:mt-5 mt-4 w-full py-3 rounded bg-green-600 text-white font-medium cursor-pointer'
              >
                My Courses
              </button>
            )}
