  ...
  return (
    <footer className='bg-gray-900 md:px-36 text-left w-full'>
         ...
         border-white/30'>
            <div className='flex flex-col md:items-start items-center w-full'>
              ...
              <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                 Expedita ad aperiam asperiores eos, voluptatum iure?</p>
            </div>
            <div className='flex flex-col md:items-start items-center w-full'>
            ...
            <div className='hidden md:flex flex-col items-start w-full'>
              <h2 className='font-semibold text-white mb-5'>
                ...
                <p className='text-sm text-white/80'>The latest news, articles, and resources, sent to 
                  your inbox weekly.
                </p>
        ...
        <p className='py-4 text-center text-xs md:text-sm text-white/60'>
          Copyright 2025 © Amr Sabsabi. All Right Reserved.
        </p>
    </footer>
  )
}
